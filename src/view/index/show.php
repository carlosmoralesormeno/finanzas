...
<section class="my-5" id="info">
    ...
    <div class="row">
        <div class="col-sm-10">
            <h2><i class="fas fa-file-invoice-dollar" aria-hidden="true"></i>&nbsp;Resumen Financiero</h2>
            <h4><?php echo $months[date($data->monthly_transactions->month)-1].' '.date($data->monthly_transactions->year)?>
            </h4>
        </div>
...
<section id="content">
    <div class="card my-3">
        <div class="card-body ">
            ...
            <h6><?php echo $months[date($data->monthly_transactions->month)-1].' '.date($data->monthly_transactions->year)?>
            </h6>
            <div class="row text-center">
                <div class="col-sm-4">
                    <h3 class="text-success"><i class="fas fa-arrow-up" aria-hidden="true">&nbsp;</i>Ingresos</h3>
                    <h4 class="text-success">$<?php echo number_format($data->monthly_transactions->income,0,',','.')?>
                    </h4>
                </div>
                <div class="col-sm-4">
                    <h3 class="text-danger"><i class="fas fa-arrow-down" aria-hidden="true">&nbsp;</i>Egresos</h3>
                    <h4 class="text-danger">$<?php echo number_format($data->monthly_transactions->expenses,0,',','.')?>
                    </h4>
                </div>
                <div class="col-sm-4">
                    <h3 class="text-primary"><i class="fas fa-funnel-dollar"></i>&nbsp;Resultado</h3>
                    <h4 class="text-primary">$<?php echo number_format($data->monthly_transactions->total,0,',','.')?>
                    </h4>
                </div>
            </div>
        </div>
...
<section>
    <div class="card my-3">
        <div class="card-body">
            <h4 class="card-title"><i class="fas fa-comments-dollar" aria-hidden="true">&nbsp;</i>Ultimas transacciones</h4>

            <?php if($data->monthly_transactions_resume):?>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php foreach ($data->monthly_transactions_resume as $key => $value) :?>
